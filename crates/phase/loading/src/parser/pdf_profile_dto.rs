...
mod test {
    ...
    #[test]
    fn PdfProfileDto__valid_partially_defined_toml_v1__EXPECT__valid_dto() {
        // Given
        let toml = r#"
        remote = "figma"
        output_dir = "images"
    ...
    #[test]
    fn PdfProfileDto__valid_partially_defined_toml_v2__EXPECT__valid_dto() {
        // Given
        let toml = r#"
        remote = "figma"
        "#;
    ...
    #[test]
    fn PdfProfileDto__valid_partially_defined_toml_v3__EXPECT__valid_dto() {
        // Given
        let toml = r#"
        "#;
        let declared_remote_ids: HashSet<_> = ["figma".to_string()].into_iter().collect();
